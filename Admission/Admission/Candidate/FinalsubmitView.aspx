<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FinalsubmitView.aspx.cs" Inherits="Admission.Admission.Candidate.FinalsubmitView" %>
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6" id="divSc" runat="server">
                                <div class="form-group">
                                    <label><strong>Donar Name<span style="color: crimson; font-weight: bold;">*</span></strong></label>
                ...
                <div class="panel-body">
                    ...
                    <asp:GridView runat="server" ID="GridViewProgramList" AutoGenerateColumns="False" AllowPaging="false" GridLines="None"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="FilePath" HeaderStyle-CssClass="header-center">
                                <ItemTemplate>
                                    <div style="padding: 5px">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <asp:FileUpload ID="FileUploadPhoto" Visible="false" runat="server" accept=".jpg,.jpeg,.png" CssClass="btn btn-secondary" Width="100%" Style="margin-bottom: 5px; border-radius: 5px; background-color: gainsboro;" ClientIDMode="Static" />
                            </div>

                            <div class="col-lg-4 col-md-4 col-sm-4" style="width: 22%;">

                                <asp:Button ID="btnUploadPhoto" runat="server" Visible="false" CssClass="btn btn-info" Style="display: inline-block; text-align: center; font-size: 14px; border-radius: 4px;" Font-Bold="true" OnClick="btnUploadPhoto_Click" Text="Upload"
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <asp:FileUpload ID="FileUploadPassport" runat="server" Visible="false"   accept=".jpg,.jpeg,.pdf" CssClass="btn btn-secondary" Width="100%" Style="margin-bottom: 5px; border-radius: 5px; background-color: gainsboro;" ClientIDMode="Static" />

                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4" style="width: 22%;">

                                <asp:Button ID="btnpassport" runat="server" Visible="false"  CssClass="btn btn-info" Style="display: inline-block; text-align: center; font-size: 14px; border-radius: 4px;" Font-Bold="true" OnClick="btnpassport_Click" Text="Upload"
                                    ClientIDMode="Static" CausesValidation="false"></asp:Button>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <asp:FileUpload ID="FileUploadSignature" runat="server"  Visible="false" accept=".jpg,.jpeg,.png" CssClass="btn btn-secondary" Width="100%" Style="margin-bottom: 5px; border-radius: 5px; background-color: gainsboro;" ClientIDMode="Static" />

                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4" style="width: 22%;">

                                <asp:Button ID="btnSignature" runat="server"  Visible="false" CssClass="btn btn-info" Style="display: inline-block; text-align: center; font-size: 14px; border-radius: 4px;" Font-Bold="true" OnClick="btnSignature_Click" Text="Upload"
                                    ClientIDMode="Static" CausesValidation="false"></asp:Button>
                            </div>
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <asp:FileUpload ID="FileUploadNID" runat="server"  Visible="false" accept=".jpg,.jpeg,.pdf" CssClass="btn btn-secondary" Width="100%" Style="margin-bottom: 5px; border-radius: 5px; background-color: gainsboro;" ClientIDMode="Static" />

                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4" style="width: 22%;">

                                <asp:Button ID="btnNID" runat="server"  Visible="false" CssClass="btn btn-info" Style="display: inline-block; text-align: center; font-size: 14px; border-radius: 4px;" Font-Bold="true" OnClick="btnNID_Click" Text="Upload"
                                    ClientIDMode="Static" CausesValidation="false"></asp:Button>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <asp:FileUpload ID="FileUploadAcademic" runat="server" Visible="false" accept=".jpg,.jpeg,.pdf" CssClass="btn btn-secondary" Width="100%" Style="margin-bottom: 5px; border-radius: 5px; background-color: gainsboro;" ClientIDMode="Static" />

                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4" style="width: 22%;">

                                <asp:Button ID="btnAcademic" runat="server" Visible="false" CssClass="btn btn-info" Style="display: inline-block; text-align: center; font-size: 14px; border-radius: 4px;" Font-Bold="true" OnClick="btnAcademic_Click" Text="Upload"
                                    ClientIDMode="Static" CausesValidation="false"></asp:Button>
                            </div>
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <asp:FileUpload ID="FileUploadPolice" runat="server" Visible="false" accept=".jpg,.jpeg,.pdf" CssClass="btn btn-secondary" Width="100%" Style="margin-bottom: 5px; border-radius: 5px; background-color: gainsboro;" ClientIDMode="Static" />

                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4" style="width: 22%;">

                                <asp:Button ID="btnPolice" runat="server" Visible="false" CssClass="btn btn-info" Style="display: inline-block; text-align: center; font-size: 14px; border-radius: 4px;" Font-Bold="true" OnClick="btnPolice_Click" Text="Upload"
                                    ClientIDMode="Static" CausesValidation="false"></asp:Button>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <asp:FileUpload ID="FileUploadBechlor" runat="server"  Visible="false"  accept=".jpg,.jpeg,.pdf" CssClass="btn btn-secondary" Width="100%" Style="margin-bottom: 5px; border-radius: 5px; background-color: gainsboro;" ClientIDMode="Static" />

                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4" style="width: 22%;">

                                <asp:Button ID="btnbachelor" runat="server"  Visible="false" CssClass="btn btn-info" Style="display: inline-block; text-align: center; font-size: 14px; border-radius: 4px;" Font-Bold="true" OnClick="btnbachelor_Click" Text="Upload"
                                    ClientIDMode="Static" CausesValidation="false"></asp:Button>
                            </div>
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <asp:FileUpload ID="FileUploadGrant" runat="server"  Visible="false" accept=".jpg,.jpeg,.pdf" CssClass="btn btn-secondary" Width="100%" Style="margin-bottom: 5px; border-radius: 5px; background-color: gainsboro;" ClientIDMode="Static" />

                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4" style="width: 22%;">

                                <asp:Button ID="btnGrant" runat="server"  Visible="false" CssClass="btn btn-info" Style="display: inline-block; text-align: center; font-size: 14px; border-radius: 4px;" Font-Bold="true" OnClick="btnGrant_Click" Text="Upload"
                                    ClientIDMode="Static" CausesValidation="false"></asp:Button>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <asp:FileUpload ID="FileUploadCV" runat="server" Visible="false" accept=".jpg,.jpeg,.pdf" CssClass="btn btn-secondary" Width="100%" Style="margin-bottom: 5px; border-radius: 5px; background-color: gainsboro;" ClientIDMode="Static" />
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4" style="width: 22%;">

                                <asp:Button ID="btnCVUpload" runat="server" Visible="false" CssClass="btn btn-info" Style="display: inline-block; text-align: center; font-size: 14px; border-radius: 4px;" Font-Bold="true" OnClick="btnCVUpload_Click" Text="Upload"
                                    ClientIDMode="Static" CausesValidation="false"></asp:Button>
                            </div>
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <asp:FileUpload ID="FileUploadHealth" runat="server" Visible="false" accept=".jpg,.jpeg,.pdf" CssClass="btn btn-secondary" Width="100%" Style="margin-bottom: 5px; border-radius: 5px; background-color: gainsboro;" ClientIDMode="Static" />

                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4" style="width: 22%;">

                                <asp:Button ID="btnHealth" runat="server" Visible="false" CssClass="btn btn-info" Style="display: inline-block; text-align: center; font-size: 14px; border-radius: 4px;" Font-Bold="true" OnClick="btnHealth_Click" Text="Upload"
                                    ClientIDMode="Static" CausesValidation="false"></asp:Button>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <asp:FileUpload ID="FileUploadEnglishCertificate" runat="server" Visible="false" accept=".jpg,.jpeg,.pdf" CssClass="btn btn-secondary" Width="100%" Style="margin-bottom: 5px; border-radius: 5px; background-color: gainsboro;" ClientIDMode="Static" />

                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4" style="width: 22%;">

                                <asp:Button ID="btnEnglishCertificate" runat="server" Visible="false" CssClass="btn btn-info" Style="display: inline-block; text-align: center; font-size: 14px; border-radius: 4px;" Font-Bold="true" OnClick="btnEnglishCertificate_Click" Text="Upload"
                                    ClientIDMode="Static" CausesValidation="false"></asp:Button>
                            </div>
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <asp:FileUpload ID="FileUploadDeposit" runat="server"  Visible="false" accept=".jpg,.jpeg,.pdf" CssClass="btn btn-secondary" Width="100%" Style="margin-bottom: 5px; border-radius: 5px; background-color: gainsboro;" ClientIDMode="Static" />

                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4" style="width: 22%;">

                                <asp:Button ID="btnDeposit" runat="server"  Visible="false" CssClass="btn btn-info" Style="display: inline-block; text-align: center; font-size: 14px; border-radius: 4px;" Font-Bold="true" OnClick="btnDeposit_Click" Text="Upload"
                                    ClientIDMode="Static" CausesValidation="false"></asp:Button>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <asp:FileUpload ID="FileUploadMedical" runat="server" Visible="false" accept=".jpg,.jpeg,.pdf" CssClass="btn btn-secondary" Width="100%" Style="margin-bottom: 5px; border-radius: 5px; background-color: gainsboro;" ClientIDMode="Static" />
                                <br />

                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4" style="width: 22%;">

                                <asp:Button ID="btnHsc" runat="server" Visible="false" CssClass="btn btn-info" Style="display: inline-block; text-align: center; font-size: 14px; border-radius: 4px;" Font-Bold="true" OnClick="btnHsc_Click" Text="Upload"
                                    ClientIDMode="Static" CausesValidation="false"></asp:Button>
                            </div>
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <asp:FileUpload ID="FileUploadTestimonial" runat="server" Visible="false" accept=".jpg,.jpeg,.pdf" CssClass="btn btn-secondary" Width="100%" Style="margin-bottom: 5px; border-radius: 5px; background-color: gainsboro;" ClientIDMode="Static" />


                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4" style="width: 22%;">

                                <asp:Button ID="btnTestimonial" runat="server" Visible="false" CssClass="btn btn-info" Style="display: inline-block; text-align: center; font-size: 14px; border-radius: 4px;" Font-Bold="true" OnClick="btnTestimonial_Click" Text="Upload"
                                    ClientIDMode="Static" CausesValidation="false"></asp:Button>
                            </div>
