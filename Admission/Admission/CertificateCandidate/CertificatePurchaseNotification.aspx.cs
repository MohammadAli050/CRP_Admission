...
{
    public partial class CertificatePurchaseNotification : System.Web.UI.Page
    {
            ...
            else
            {
                if (!IsPostBack)
                {
                    ...
                    if (isMultiple == false) //if not multiple purchase...single form purchase from purchaseForm.aspx.
                    {
                        ...
                        {
                            DAL.CertificateAdmissionUnit admUnit = db.AdmissionDB.CertificateAdmissionUnits.Find(admUnitId);
                            DAL.CertificateCandidatePayment candidatePaymentObj = db.AdmissionDB.CertificateCandidatePayments.Find(candidatePaymentID);
                            DAL.CertificateCandidateFormSl candidateFormSlObj = db.AdmissionDB.CertificateCandidateFormSls.Find(Convert.ToInt64(candidateFormSerialID));
                            DAL.CertificateBasicInfo candidateBasicInfoObj = db.AdmissionDB.CertificateBasicInfoes.Find(candidatePaymentObj.CandidateID);
                            if (candidatePaymentObj != null && admUnit != null && candidateFormSlObj != null && candidateBasicInfoObj != null)
                            {

                                DAL.CertificateAdmissionSetup admSetupObj = null;
                                using (var dbAdmSetup = new OfficeDataManager())
                                {
                                    admSetupObj = dbAdmSetup.AdmissionDB.CertificateAdmissionSetups.Find(candidateFormSlObj.AdmissionSetupID);
                                }
                                ...
                                List<DAL.SPCertificateGetCandidateSMSEmailCntByPmtIdMobPurchaseNotification_Result> result = null;
                                using (var db1 = new OfficeDataManager())
                                {
                                    result = db1.AdmissionDB.SPCertificateGetCandidateSMSEmailCntByPmtIdMobPurchaseNotification(candidatePaymentObj.PaymentId, null).ToList();
                                }
                                ...
                                else
                                {
                                    string mailBody = "Dear " + candidateBasicInfoObj.FirstName + ", <br/><br/>" +
                                                        ...
                                                        "<br/><br/>" +
                                                        "<b>Link : </b><a href='https://admission.bup.edu.bd/Admission/CertificateCandidate/CertificatePurchaseNotification.aspx?value=" + value + "'> https://admission.bup.edu.bd/Admission/CertificateCandidate/CertificatePurchaseNotification.aspx?value=value </a>" +
                                                        "<br/><br/>" +
                                    ...
                                    if (isSentEmail == true)
                                    {
                                        ...
                                        eLog.Page = "CertificatePurchaseNotification.aspx";
                                        eLog.SentBy = "System";
        ...
        private void GetSendingInfo(long? candidateId, string value, DAL.CertificateCandidatePayment candidatePaymentObj, DAL.CertificateBasicInfo candidateBasicInfoObj)
        {
            if (candidateId != null)
            {
                if (candidateId > 0)
        ...
        private void SendSms(string smsPhone, long candidateId, string value, DAL.CertificateCandidatePayment candidatePaymentObj, DAL.CertificateBasicInfo candidateBasicInfoObj)
        {
            if (!string.IsNullOrEmpty(smsPhone) && smsPhone.Count() == 14 && smsPhone.Contains("+"))
            {
                ...
                //                    "and Payment Link : https://admission.bup.edu.bd/Admission/CertificateCandidate/CertificatePurchaseNotification.aspx?value=" + value + "\n" +
                //                    "BUP";
                ...
                if (statusT != "200") //if sms sending fails
                {
                    ...
                    smsLog.Attribute1 = "Sms sending failed in CertificatePurchaseNotification.aspx";
                ...
                else //if sms sending passed
                {
                    DAL_Log.SmsLog smsLog = new DAL_Log.SmsLog();
                    smsLog.AcaCalId = null;
                    smsLog.Attribute1 = "Sms sending successful CertificatePurchaseNotification.aspx";
