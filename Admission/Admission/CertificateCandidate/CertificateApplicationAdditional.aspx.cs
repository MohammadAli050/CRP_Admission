...
{
    public partial class CertificateApplicationAdditional : PageBase
    {
        ...
        private void LoadCandidateData(long cId)
        {
            if (cId > 0)
            {
                ...
                using (var db = new CandidateDataManager())
                {
                    List<DAL.CertificateExtraCurricularActivity> extraCurActList = db.AdmissionDB.CertificateExtraCurricularActivities.Where(x=> x.CandidateID == cId).ToList();//db.GetAllExtraCurricularActivityByCandidateID_ND(cId);
                    if (extraCurActList != null)
                    {
                        DAL.CertificateExtraCurricularActivity activity1 = extraCurActList.Where(c => c.Attribute1 == "1").FirstOrDefault();
                        DAL.CertificateExtraCurricularActivity activity2 = extraCurActList.Where(c => c.Attribute1 == "2").FirstOrDefault();
        ...
        protected void btnSave_Additional_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (cId > 0)
                {
                    ...
                    List<DAL.CertificateExtraCurricularActivity> extraCurricularList = null;

                    DAL.CertificateExtraCurricularActivity extraCurricularAct1 = null;
                    DAL.CertificateExtraCurricularActivity extraCurricularAct2 = null;

                    using (var db = new CandidateDataManager())
                    {
                        extraCurricularList = db.AdmissionDB.CertificateExtraCurricularActivities.Where(x=> x.CandidateID == cId).ToList();//db.GetAllExtraCurricularActivityByCandidateID_ND(cId);
                    ...
                    if (!string.IsNullOrEmpty(txtActivity1.Text.Trim()))
                    {
                        if (extraCurricularAct1 != null) //extra curricular activity 1 exists, update.
                        {
                            ...
                            {
                                dbUpdateECA1.Update<DAL.CertificateExtraCurricularActivity>(extraCurricularAct1);
                            }
                        }
                        else //extra curricula activity 1 does not exist. create new.
                        {
                            DAL.CertificateExtraCurricularActivity newExtraCurricularAct1 = new DAL.CertificateExtraCurricularActivity();
                            ...
                            if (!string.IsNullOrEmpty(txtActivity1.Text))
                            {
                                ...
                                {
                                    dbInsertECA1.Insert<DAL.CertificateExtraCurricularActivity>(newExtraCurricularAct1);
                                }
                            }
                        }
                    }
                    ...
                    if (!string.IsNullOrEmpty(txtActivity2.Text.Trim()))
                    {
                        if (extraCurricularAct2 != null) //extra curricular activity 2 exists, update.
                        {
                            ...
                            {
                                dbUpdateECA2.Update<DAL.CertificateExtraCurricularActivity>(extraCurricularAct2);
                            }
                        }
                        else //extra curricula activity 2 does not exist. create new.
                        {
                            DAL.CertificateExtraCurricularActivity newExtraCurricularAct2 = new DAL.CertificateExtraCurricularActivity();
                            ...
                            if (!string.IsNullOrEmpty(txtActivity1.Text))
                            {
                                ...
                                {
                                    dbInsertECA2.Insert<DAL.CertificateExtraCurricularActivity>(newExtraCurricularAct2);
                                }
                            }
                        }
                    }
