...
{
    public partial class CertificateApplicationEducation : PageBase
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            {
                cId = certificateBasicInfo.ID; ; //Int64.Parse(Request.QueryString["val"].ToString());

                string queryVal = Encrypt.EncryptString(cId.ToString());
        ...
        private void LoadCandidateData(long cId)
        {
            if (cId > 0)
            {
                ...
                List<DAL.CertificateCandidateFormSl> candidateFormSlList = null;
                DAL.CertificateAdmissionSetup admSetup = null;

                using (var db = new CandidateDataManager())
                {
                    candidateFormSlList = db.AdmissionDB.CertificateCandidateFormSls.Where(x => x.CandidateID == cId).ToList();
                    if (candidateFormSlList != null)
                    {
                        //get only admSetup for masters.
                        admSetup = db.AdmissionDB.CertificateAdmissionSetups.Where(x => x.EducationCategoryID == 1).FirstOrDefault();
                ...
                using (var db = new CandidateDataManager())
                {
                    ...
                    DAL.CertificateExam secondaryExam = db.GetCertificateSecondaryExamByCandidateID_AD(cId);
                    DAL.CertificateExam higherSecondaryExam = db.GetCertificateHigherSecdExamByCandidateID_AD(cId);
                    DAL.CertificateExam undergradExam = db.GetCertificateUndergradExamByCandidateID_AD(cId);
                    DAL.CertificateExam gradExam = db.GetCertificateGradExamByCandidateID_AD(cId);

                    if (secondaryExam != null)
                    {
                        DAL.CertificateExamDetail secExamDetail = db.AdmissionDB.CertificateExamDetails.Where(x => x.ID == secondaryExam.ExamDetailsID).FirstOrDefault();
                    ...
                    {
                        DAL.CertificateExamDetail higherSecExamDetail = db.AdmissionDB.CertificateExamDetails.Where(x => x.ID == higherSecondaryExam.ExamDetailsID).FirstOrDefault();
                    ...
                    {
                        DAL.CertificateExamDetail undergradExamDetail = db.AdmissionDB.CertificateExamDetails.Where(x => x.ID == undergradExam.ExamDetailsID).FirstOrDefault();
                    ...
                    if (gradExam != null)
                    {
                        DAL.CertificateExamDetail gradExamDetail = db.AdmissionDB.CertificateExamDetails.Where(x => x.ID == gradExam.ExamDetailsID).FirstOrDefault();
        ...
        protected void btnSave_Education_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (cId > 0)
                {
                    ...
                    DAL.CertificateExam secondaryExam = null;
                    DAL.CertificateExam highSecondaryExam = null;
                    DAL.CertificateExam undergradExam = null;
                    DAL.CertificateExam gradExam = null;

                    using (var db = new CandidateDataManager())
                    {
                        //List<DAL.Exam> examList = db.GetAllExamByCandidateID_AD(cId);

                        List<DAL.CertificateExam> examList = db.AdmissionDB.CertificateExams.Where(x=> x.CandidateID == cId).ToList();
                    ...
                    {
                        DAL.CertificateExamDetail secExmDtlObj = new DAL.CertificateExamDetail();
                          
                        using (var db = new CandidateDataManager())
                        {
                            secExmDtlObj = db.AdmissionDB.CertificateExamDetails.Where(x=> x.ID == secondaryExam.ExamDetailsID).FirstOrDefault();
                        }
                        ...
                        if (secExmDtlObj != null) // secondary exam detail exist. Update.
                        {
                            ...
                            {
                                dbUpdateSecExamDetails.Update<DAL.CertificateExamDetail>(secExmDtlObj);
                            }
                        }
                        else //secondary exam detail does not exist. create update exam details.
                        {
                            DAL.CertificateExamDetail newSecExmDtlObj = new DAL.CertificateExamDetail();
                            ...
                            {
                                dbInsertSecExamDetails.Insert<DAL.CertificateExamDetail>(newSecExmDtlObj);
                            ...
                            if (newSecExmDtlObjID > 0)
                            {
                                ...
                                {
                                    dbUpdateSecExam.Update<DAL.CertificateExam>(secondaryExam);
                                }
                            }
                        }
                    }
                    else //secondary exam does not exist.
                    {
                        ...
                        DAL.CertificateExam newSecExamObj = new DAL.CertificateExam();
                        ...
                        {
                            dbInsertSecExamDtl.Insert<DAL.CertificateExamDetail>(newSecExmDtlObj);
                            newSecExamObj.ExamDetailsID = newSecExmDtlObj.ID;
                        }
                        using (var dbInsertSecExam = new CandidateDataManager())
                        {
                            dbInsertSecExam.Insert<DAL.CertificateExam>(newSecExamObj);
                        }
                    }
                    ...
                    {
                        DAL.CertificateExamDetail higherSecExmDtlObj = new DAL.CertificateExamDetail();

                        using (var db = new CandidateDataManager())
                        {
                            higherSecExmDtlObj = db.AdmissionDB.CertificateExamDetails.Where(x => x.ID == highSecondaryExam.ExamDetailsID).FirstOrDefault();
                        }
                        ...
                        if (higherSecExmDtlObj != null) // higher secondary exam detail exist. Update.
                        {
                            ...
                            {
                                dbUpdateHighSecExamDetails.Update<DAL.CertificateExamDetail>(higherSecExmDtlObj);
                            }
                        }
                        else //higher secondary exam detail does not exist. create update exam details.
                        {
                            DAL.CertificateExamDetail newHigherSecExmDtlObj = new DAL.CertificateExamDetail();
                            ...
                            {
                                dbInsertHighSecExamDetails.Insert<DAL.CertificateExamDetail>(newHigherSecExmDtlObj);
                            ...
                            if (newHighSecExmDtlObjID > 0)
                            {
                                ...
                                {
                                    dbUpdateHighSecExam.Update<DAL.CertificateExam>(highSecondaryExam);
                                }
                            }
                        }
                    }
                    ...
                    {
                        DAL.CertificateExamDetail newHighSecExmDtlObj = new DAL.CertificateExamDetail();
                        ...
                        DAL.CertificateExam newHighSecExamObj = new DAL.CertificateExam();
                        ...
                        {
                            dbInsertHighSecExamDtl.Insert<DAL.CertificateExamDetail>(newHighSecExmDtlObj);
                            newHighSecExamObj.ExamDetailsID = newHighSecExmDtlObj.ID;
                        }
                        using (var dbInsertHighSecExam = new CandidateDataManager())
                        {
                            dbInsertHighSecExam.Insert<DAL.CertificateExam>(newHighSecExamObj);
                        }
                    }
                    ...
                    List<DAL.CertificateCandidateFormSl> candidateFormSlList = new List<DAL.CertificateCandidateFormSl>();
                    List < DAL.CertificateAdmissionSetup> admSetupList = new List<DAL.CertificateAdmissionSetup>();
                    DAL.CertificateAdmissionSetup admSetup = new DAL.CertificateAdmissionSetup();

                    using (var db = new CandidateDataManager())
                    {
                        candidateFormSlList = db.AdmissionDB.CertificateCandidateFormSls.Where(x=> x.CandidateID == cId).ToList(); //db.GetAllCandidateFormSlByCandID_AD(cId);
                        if (candidateFormSlList != null)
                        {
                            admSetupList = db.AdmissionDB.CertificateAdmissionSetups.ToList();
                            //get only admSetup for masters.
                            //admSetup = candidateFormSlList.Where(c => c.AdmissionSetup.EducationCategoryID == 6).Select(c => c.AdmissionSetup).FirstOrDefault();
                        ...
                        if (admSetup.EducationCategoryID == 1) //applying for masters...hence undergrad info is saved/updated.
                        {
                                ...
                                Int32.Parse(ddlUndergrad_PassingYear.SelectedValue) > 0)
                            {
                                ...
                                if (undergradExam != null) //undergrad exam exist.
                                {
                                    ...
                                    DAL.CertificateExamDetail undergradExmDtlObj = new DAL.CertificateExamDetail();

                                    using (var db = new CandidateDataManager())
                                    {
                                        undergradExmDtlObj = db.AdmissionDB.CertificateExamDetails.Where(x => x.ID == undergradExam.ExamDetailsID).FirstOrDefault();
                                    }
                                    ...
                                    if (undergradExmDtlObj != null) // undergrad exam detail exist. Update.
                                    {
                                        ...
                                        {
                                            dbUpdateUndergradExamDetails.Update<DAL.CertificateExamDetail>(undergradExmDtlObj);
                                        }
                                    }
                                    else //undergrad exam detail does not exist. create new exam details.
                                    {
                                        DAL.CertificateExamDetail newUndergradExmDtlObj = new DAL.CertificateExamDetail();
                                        ...
                                        {
                                            dbInsertUndergradExamDetails.Insert<DAL.CertificateExamDetail>(newUndergradExmDtlObj);
                                        ...
                                        if (newUndergradExmDtlObjID > 0)
                                        {
                                            ...
                                            {
                                                dbUpdateUndergradExam.Update<DAL.CertificateExam>(undergradExam);
                                            }
                                        }
                                    }
                                }
                                else //undergrad exam does not exist. Create new exam detail and then exam.
                                {
                                    ...
                                    DAL.CertificateExam newUndergradExamObj = new DAL.CertificateExam();
                                    ...
                                    {
                                        dbInsertUndergradExamDtl.Insert<DAL.CertificateExamDetail>(newUndergradExmDtlObj);
                                        newUndergradExamObj.ExamDetailsID = newUndergradExmDtlObj.ID;
                                    }
                                    using (var dbInsertUndergradExam = new CandidateDataManager())
                                    {
                                        dbInsertUndergradExam.Insert<DAL.CertificateExam>(newUndergradExamObj);
                                    }
                                }
                            }
                                ...
                                Int32.Parse(ddlGraduate_PassingYear.SelectedValue) > 0)
                            {
                                ...
                                if (gradExam != null) //grad exam exist.
                                {
                                    ...
                                    DAL.CertificateExamDetail gradExmDtlObj = new DAL.CertificateExamDetail();

                                    using (var db = new CandidateDataManager())
                                    {
                                        gradExmDtlObj = db.AdmissionDB.CertificateExamDetails.Where(x => x.ID == gradExam.ExamDetailsID).FirstOrDefault();
                                    }
                                    ...
                                    if (gradExmDtlObj != null) // grad exam detail exist. Update.
                                    {
                                        ...
                                        {
                                            dbUpdateGradExamDetails.Update<DAL.CertificateExamDetail>(gradExmDtlObj);
                                        }
                                    }
                                    else //grad exam detail does not exist. create new exam details.
                                    {
                                        DAL.CertificateExamDetail newGradExmDtlObj = new DAL.CertificateExamDetail();
                                        ...
                                        {
                                            dbInsertGradExamDetails.Insert<DAL.CertificateExamDetail>(newGradExmDtlObj);
                                        ...
                                        if (newGradExmDtlObjID > 0)
                                        {
                                            ...
                                            {
                                                dbUpdateGradExam.Update<DAL.CertificateExam>(gradExam);
                                            }
                                        }
                                    }
                                }
                                else //undergrad exam does not exist. Create new exam detail and then exam.
                                {
                                    ...
                                    DAL.CertificateExam newGradExamObj = new DAL.CertificateExam();
                                    ...
                                    using (var dbInsertHighSecExamDtl = new CandidateDataManager())
                                    {
                                        dbInsertHighSecExamDtl.Insert<DAL.CertificateExamDetail>(newGradExmDtlObj);
                                        newGradExamObj.ExamDetailsID = newGradExmDtlObj.ID;
                                    }
                                    using (var dbInsertHighSecExam = new CandidateDataManager())
                                    {
                                        dbInsertHighSecExam.Insert<DAL.CertificateExam>(newGradExamObj);
                                    }
                                }
