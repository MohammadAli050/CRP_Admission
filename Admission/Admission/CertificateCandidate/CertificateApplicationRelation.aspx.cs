...
{
    public partial class CertificateApplicationRelation : PageBase
    {
        ...
        private void LoadCandidateData(long cId)
        {
            if (cId > 0)
            {
                ...
                {
                    List<DAL.CertificateRelation> relationList = db.AdmissionDB.CertificateRelations.Where(x => x.CandidateID == cId).ToList(); //db.GetAllRelationByCandidateID_ND(cId);
                    if (relationList != null)
                    {
                        DAL.CertificateRelation fatherRelation = relationList.Where(a => a.RelationTypeID == 2).FirstOrDefault();
                        DAL.CertificateRelation motherRelation = relationList.Where(a => a.RelationTypeID == 3).FirstOrDefault();
                        ...
                        {
                            DAL.CertificateRelationDetail father = db.AdmissionDB.CertificateRelationDetails.Where(x=> x.ID == fatherRelation.RelationDetailsID).FirstOrDefault();//db.GetRelationDetailByID_ND(fatherRelation.RelationDetailsID);
                            if (father != null)
                            {
                        ...
                        {
                            DAL.CertificateRelationDetail mother = db.AdmissionDB.CertificateRelationDetails.Where(x=> x.ID == motherRelation.RelationDetailsID).FirstOrDefault();//db.GetRelationDetailByID_ND(motherRelation.RelationDetailsID);
                            if (mother != null)
                            {
        ...
        protected void btnSave_Parent_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (cId > 0)
                {
                    DAL.CertificateRelation father = null;
                    DAL.CertificateRelation mother = null;
                    //DAL.Relation guardian = null;

                    using (var db = new CandidateDataManager())
                    {
                        List<DAL.CertificateRelation> relationList = null;

                        relationList = db.AdmissionDB.CertificateRelations.Where(x=> x.CandidateID == cId).ToList();//db.GetAllRelationByCandidateID_AD(cId);
                    ...
                    if (father != null) // relation (father) object exist
                    {
                        ...
                        DAL.CertificateRelationDetail fatherRelationDetail = new DAL.CertificateRelationDetail(); //father.RelationDetail;
                        List<DAL.CertificateRelationDetail> fatherRelationDetailList = new List<DAL.CertificateRelationDetail>();
                        using (var db = new CandidateDataManager())
                        {
                            fatherRelationDetailList = db.AdmissionDB.CertificateRelationDetails.ToList();
                            ...
                            if (fatherRelationDetail != null) // relationDetails (father) object exist, update
                            {
                                ...
                                {
                                    dbUpdateFatherRelationDetails.Update<DAL.CertificateRelationDetail>(fatherRelationDetail);
                                }
                            }
                            else // relationDetails (father) does not exist, create new then update relation
                            {
                                DAL.CertificateRelationDetail newFatherRelationDetails = new DAL.CertificateRelationDetail();
                                ...
                                {
                                    dbInsertFatherRelationDetails.Insert<DAL.CertificateRelationDetail>(newFatherRelationDetails);
                                ...
                                if (newFatherRelationDetailsID > 0)
                                {
                                    ...
                                    {
                                        dbUpdateFatherRelation.Update<DAL.CertificateRelation>(father);
                                    }
                                }
                            }
                    }
                    else // relation (father) object does not exist, first create a relation details and then relation
                    {
                        ...
                        DAL.CertificateRelation newFatherRelation = new DAL.CertificateRelation();
                        ...
                        {
                            dbRelationDetailsInsert.Insert<DAL.CertificateRelationDetail>(newFatherRelationDetails);
                            newFatherRelation.RelationDetailsID = newFatherRelationDetails.ID;
                        }
                        using (var dbRelationInsert = new CandidateDataManager())
                        {
                            dbRelationInsert.Insert<DAL.CertificateRelation>(newFatherRelation);
                        }
                    }
                    ...
                    if (mother != null) // relation (mother) object exist
                    {
                        ...
                        DAL.CertificateRelationDetail motherRelationDetail = new DAL.CertificateRelationDetail(); //father.RelationDetail;
                        List<DAL.CertificateRelationDetail> motherRelationDetailList = new List<DAL.CertificateRelationDetail>();
                        using (var db = new CandidateDataManager())
                        {
                            motherRelationDetailList = db.AdmissionDB.CertificateRelationDetails.ToList();
                        ...
                        if (motherRelationDetail != null) // relationDetails (mother) object exist, update
                        {
                            ...
                            {
                                dbUpdateMotherRelationDetails.Update<DAL.CertificateRelationDetail>(motherRelationDetail);
                            }
                        }
                        else // relationDetails (mother) does not exist, create new then update relation
                        {
                            DAL.CertificateRelationDetail newMotherRelationDetails = new DAL.CertificateRelationDetail();
                            ...
                            using (var dbInsertFatherRelationDetails = new CandidateDataManager())
                            {
                                dbInsertFatherRelationDetails.Insert<DAL.CertificateRelationDetail>(newMotherRelationDetails);
                            ...
                            if (newMotherRelationDetailsID > 0)
                            {
                                ...
                                {
                                    dbUpdateMotherRelation.Update<DAL.CertificateRelation>(mother);
                                }
                            }
                        }
                    }
                    else // relation (mohter) object does not exist, first create a relation details and then relation
                    {
                        ...
                        DAL.CertificateRelation newMotherRelation = new DAL.CertificateRelation();
                        ...
                        using (var dbRelationDetailsInsert = new CandidateDataManager())
                        {
                            dbRelationDetailsInsert.Insert<DAL.CertificateRelationDetail>(newMotherRelationDetails);
                            newMotherRelation.RelationDetailsID = newMotherRelationDetails.ID;
                        }
                        using (var dbRelationInsert = new CandidateDataManager())
                        {
                            dbRelationInsert.Insert<DAL.CertificateRelation>(newMotherRelation);
                        }
                    }
