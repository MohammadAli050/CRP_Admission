...
{
    public partial class ResendSmsHelpDesk : PageBase
    {
                    ...
                    if (candidate != null)
                    {
                        ...
                        if (cu != null)
                        {
                            ...
                            if (statusT != "200") //if sms sending fails
                            {
                                ...
                                smsLog.Attribute1 = "Sms sending failed in ResendSmsHelpDesk.aspx";
                            ...
                            else //if sms sending passed
                            {
                                DAL_Log.SmsLog smsLog = new DAL_Log.SmsLog();
                                smsLog.AcaCalId = null;
                                smsLog.Attribute1 = "Sms sending successful ResendSmsHelpDesk.aspx";
