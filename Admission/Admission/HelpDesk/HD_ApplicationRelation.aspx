<%@ Page Title="" Language="C#" MasterPageFile="~/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="HD_ApplicationRelation.aspx.cs" Inherits="Admission.Admission.HelpDesk.HD_ApplicationRelation" %>
            ...
            <div class="panel panel-default">
                <div class="panel-heading panelHeaderHeight">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><asp:HyperLink ID="hrefAppRelation" runat="server">Parent/Guardian</asp:HyperLink></li>
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-body panelBody_edu_marginBottom">
                                                <table style="width: 100%" class="table table-condensed">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList ID="ddlIsLateFather" runat="server" Width="85%" CssClass="form-control" AutoPostBack="true"
                                                                OnSelectedIndexChanged="ddlIsLateFather_SelectedIndexChanged"></asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td class="style_td">National ID / Birth Cert No. / Passport No. <span class="spanAsterisk">*</span></td>
                                                        <td>
                                            ...
                                            <div class="panel-body panelBody_edu_marginBottom">
                                                <table style="width: 100%" class="table table-condensed">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList ID="ddlIsLateMother" runat="server" Width="85%" CssClass="form-control" AutoPostBack="true"
                                                                OnSelectedIndexChanged="ddlIsLateMother_SelectedIndexChanged"></asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                    <tr style="display: none">
                                                        <td class="style_td">Occupation <span class="spanAsterisk">*</span></td>
                                                    ...
                                                    <tr>
                                                        <td class="style_td">National ID / Birth Cert No. / Passport No. <span class="spanAsterisk">*</span></td>
                                                        <td>
                                                            <asp:TextBox ID="txtMotherNationalId" runat="server" Width="100%" TextMode="Number" CssClass="form-control"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="style_td">Nationality <span class="spanAsterisk">*</span></td>
                                                        <td>
                                                            <asp:DropDownList ID="ddlMotherNationality" runat="server" Width="85%" CssClass="form-control"></asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                    ...
                                    <%--<div class="col-md-6">
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-body panelBody_edu_marginBottom">
                                                <table style="width: 100%" class="table table-condensed">
                                                    <tr>
                                                        <td style="width: 30%" class="style_td">Spouse Name</td>
                                                        <td style="width: 70%">
                                                            <asp:TextBox ID="txtSpouceName" runat="server" Width="100%" CssClass="form-control"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="style_td">Occupation</td>
                                                        <td>
                                                            <asp:TextBox ID="txtSpouseOccupation" runat="server" Width="100%" CssClass="form-control"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="style_td">Address<br />
                                                            (Postal)</td>
                                                        <td>
                                                            <asp:TextBox ID="txtSpouseMailingAddress" runat="server" Width="100%" CssClass="form-control"
                                                                TextMode="MultiLine"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtSpouseMobile" runat="server" Width="100%" CssClass="form-control"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
