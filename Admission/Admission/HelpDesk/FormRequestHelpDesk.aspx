<%@ Page Title="" Language="C#" MasterPageFile="~/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="FormRequestHelpDesk.aspx.cs" Inherits="Admission.Admission.HelpDesk.FormRequestHelpDesk" %>
                    ...
                    <table class="table_form" style="width: 100%">
                        ...
                        <tr>
                            ...
                            <td style="padding-right: 0%">
                                <asp:TextBox ID="txtSearchText" runat="server" Width="94%" CssClass="float-left" placeholder="Form Serial / Payment ID / Mobile"></asp:TextBox>
