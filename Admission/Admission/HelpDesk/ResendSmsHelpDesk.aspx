<%@ Page Title="Help Desk - Resend SMS & Email" Language="C#" MasterPageFile="~/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="ResendSmsHelpDesk.aspx.cs" Inherits="Admission.Admission.HelpDesk.ResendSmsHelpDesk" %>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <asp:Panel ID="messagePanel" runat="server">
                        Message: <asp:Label ID="lblMessage" runat="server"></asp:Label>
                    </asp:Panel>
                    <table class="table_form table_fullwidth">
                        <tr>
                            <td>Mobile Number</td>
                            <td>
                                <asp:TextBox ID="txtMobile" runat="server" placeholer="+88017XXXXXXXX"></asp:TextBox>
                            </td>
                            <td>Payment ID</td>
                            <td>
