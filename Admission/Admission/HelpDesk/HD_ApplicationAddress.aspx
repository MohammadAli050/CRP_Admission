<%@ Page Title="" Language="C#" MasterPageFile="~/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="HD_ApplicationAddress.aspx.cs" Inherits="Admission.Admission.HelpDesk.HD_ApplicationAddress" %>
            ...
            <div class="panel panel-default">
                <div class="panel-heading panelHeaderHeight">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><asp:HyperLink ID="hrefAppAddress" runat="server">Address</asp:HyperLink></li>
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-body panelBody_edu_marginBottom">
                                                <table style="width: 100%" class="table table-condensed">
                                                    <tr>
                                                        <td style="width: 31%" class="style_td">Address <span class="spanAsterisk">*</span><br />
                                                            </td>
                                                        <td style="width: 69%">
