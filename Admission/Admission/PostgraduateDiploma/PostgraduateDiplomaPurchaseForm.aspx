<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PostgraduateDiplomaPurchaseForm.aspx.cs" Inherits="Admission.Admission.PostgraduateDiploma.PostgraduateDiplomaPurchaseForm" %>
        ...
        <div class="col-md-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <asp:UpdatePanel ID="updatePanel_EligibleMessageUP" runat="server" Visible="false">
                                <ContentTemplate>
                                    <div class="alert alert-danger" role="alert">
                                        <asp:Label ID="lblEligibleMsgUP" runat="server" Font-Bold="true"></asp:Label>
                                    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    ...
                                    <div>
                                        <asp:TextBox ID="txtSmsMobile" runat="server" Width="83%" CssClass="form-control" placeholder="01XXXXXXXXX" MaxLength="11"></asp:TextBox>
                    ...
                    <table style="width: 100%">
                        ...
                        <tr>
                            <td colspan="2" class="auto-style1">
                                <asp:UpdatePanel ID="updatePanel_EligibleMessage" runat="server" Visible="false">
                                    <ContentTemplate>
                                        <div class="alert alert-danger" role="alert">
