<%@ Page Title="" Language="C#" MasterPageFile="~/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="CandApplicationAdditional.aspx.cs" Inherits="Admission.Admission.PostgraduateDiploma.PDCandidateInfo.CandApplicationAdditional" %>
            ...
            <div class="panel panel-default">
                <div class="panel-heading panelHeaderHeight">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><asp:HyperLink ID="hrefAppAdditional" runat="server" Enabled="false">Additional/Work Experience</asp:HyperLink></li>
                    ...
                    <asp:UpdatePanel ID="updatePanelAdditional" runat="server">
                        <ContentTemplate>
                            ...
                            <asp:Panel ID="panel_Occupation" runat="server">
                                <%--<table style="width: 100%" class="table table-condensed table-striped">
                                    <tr>
                                        <th class="info" colspan="4">Occupation details (if any) </th>
                                        <tr>
