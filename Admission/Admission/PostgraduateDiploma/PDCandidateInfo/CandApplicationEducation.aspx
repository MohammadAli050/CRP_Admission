<%@ Page Title="" Language="C#" MasterPageFile="~/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="CandApplicationEducation.aspx.cs" Inherits="Admission.Admission.PostgraduateDiploma.PDCandidateInfo.CandApplicationEducation" %>
            ...
            <div class="panel panel-default">
                <div class="panel-heading panelHeaderHeight">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><asp:HyperLink ID="hrefAppEducation" runat="server" Enabled="false">Education</asp:HyperLink></li>
