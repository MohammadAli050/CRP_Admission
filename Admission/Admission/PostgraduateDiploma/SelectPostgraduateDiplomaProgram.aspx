<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SelectPostgraduateDiplomaProgram.aspx.cs" Inherits="Admission.Admission.PostgraduateDiploma.SelectPostgraduateDiplomaProgram" %>
                    ...
                    <asp:ListView ID="lvAdmSetup" runat="server"
                        ...
                        <LayoutTemplate>
                            <table id="tblAdmSetup"
                                ...
                                <th runat="server">Start Date</th>
                                <th runat="server">End Date</th>
                                <th runat="server" style="display: none;">Fee</th>
                                <th runat="server"></th>
                                <tr runat="server" id="itemPlaceholder" />
                            </table>
                        ...
                        <ItemTemplate>
                            <tr runat="server">
                                ...
                                <td valign="middle" align="left" class="" style="display: none;">BDT.
                                    <asp:Label ID="lblFee" runat="server" />
                                </td>
                                <td valign="middle" align="right" class="">
