...
{
    public partial class SelectPostgraduateDiplomaProgram : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (educationCategory == 1)
                {
                    ...
                    if (educationCategory == 1)
                    {
                        lblEducationCat.Text = "Postgraduate Diploma Program";
        ...
        private void LoadListView(int educataionCategoryId)
        {
            ...
            {
                List<DAL.PostgraduateDiplomaAdmissionSetup> list = db.GetAllPostgraduateDiplomaAdmissionSetupByEducationCategoryID(educataionCategoryId, true)
        ...
        protected void lvAdmSetup_ItemDataBound(object sender, ListViewItemEventArgs e)
        {
            if (e.Item.ItemType == ListViewItemType.DataItem)
            {
                ...
                DAL.PostgraduateDiplomaAdmissionSetup admissionSetup = (DAL.PostgraduateDiplomaAdmissionSetup)((ListViewDataItem)(e.Item)).DataItem;
                ...
                lblUnitName.Text = admissionSetup.AdmissionUnitID == 1 ? "Postgraduate Diploma in Higher Education Teaching" : "";
            ...
            if (e.CommandName == "ViewDetails")
            {
                ...
                using (var db = new OfficeDataManager())
                {
                    ...
                    if (admissionSetup.ID > 0 && admissionSetup.IsActive == true)
                    {
                        ...
                        {
                            Response.Redirect("~/Admission/PostgraduateDiploma/PostgraduateDiplomaPurchaseForm.aspx?asi=" + admissionSetup.ID + "&aui=" + admissionUnit.ID, false);
                        }
                        else
                        {
