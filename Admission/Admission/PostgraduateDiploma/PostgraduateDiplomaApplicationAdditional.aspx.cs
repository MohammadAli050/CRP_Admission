...
{
    public partial class PostgraduateDiplomaApplicationAdditional : PageBase
    {
        ...
        private void LoadCandidateData(long cId)
        {
            if (cId > 0)
            {
                ...
                using (var db = new CandidateDataManager())
                {
                    List<DAL.PostgraduateDiplomaExtraCurricularActivity> extraCurActList = db.AdmissionDB.PostgraduateDiplomaExtraCurricularActivities.Where(x => x.CandidateID == cId).ToList();//db.GetAllExtraCurricularActivityByCandidateID_ND(cId);
                    if (extraCurActList != null)
                    {
                        DAL.PostgraduateDiplomaExtraCurricularActivity activity1 = extraCurActList.Where(c => c.Attribute1 == "1").FirstOrDefault();
                        DAL.PostgraduateDiplomaExtraCurricularActivity activity2 = extraCurActList.Where(c => c.Attribute1 == "2").FirstOrDefault();
        ...
        protected void btnSave_Additional_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (cId > 0)
                {
                    ...
                    List<DAL.PostgraduateDiplomaExtraCurricularActivity> extraCurricularList = null;

                    DAL.PostgraduateDiplomaExtraCurricularActivity extraCurricularAct1 = null;
                    DAL.PostgraduateDiplomaExtraCurricularActivity extraCurricularAct2 = null;

                    using (var db = new CandidateDataManager())
                    {
                        extraCurricularList = db.AdmissionDB.PostgraduateDiplomaExtraCurricularActivities.Where(x => x.CandidateID == cId).ToList();//db.GetAllExtraCurricularActivityByCandidateID_ND(cId);
                    ...
                    if (!string.IsNullOrEmpty(txtActivity1.Text.Trim()))
                    {
                        if (extraCurricularAct1 != null) //extra curricular activity 1 exists, update.
                        {
                            ...
                            {
                                dbUpdateECA1.Update<DAL.PostgraduateDiplomaExtraCurricularActivity>(extraCurricularAct1);
                            }
                        }
                        else //extra curricula activity 1 does not exist. create new.
                        {
                            DAL.PostgraduateDiplomaExtraCurricularActivity newExtraCurricularAct1 = new DAL.PostgraduateDiplomaExtraCurricularActivity();
                            ...
                            if (!string.IsNullOrEmpty(txtActivity1.Text))
                            {
                                ...
                                {
                                    dbInsertECA1.Insert<DAL.PostgraduateDiplomaExtraCurricularActivity>(newExtraCurricularAct1);
                                }
                            }
                        }
                    }
                    ...
                    if (!string.IsNullOrEmpty(txtActivity2.Text.Trim()))
                    {
                        if (extraCurricularAct2 != null) //extra curricular activity 2 exists, update.
                        {
                            ...
                            {
                                dbUpdateECA2.Update<DAL.PostgraduateDiplomaExtraCurricularActivity>(extraCurricularAct2);
                            }
                        }
                        else //extra curricula activity 2 does not exist. create new.
                        {
                            DAL.PostgraduateDiplomaExtraCurricularActivity newExtraCurricularAct2 = new DAL.PostgraduateDiplomaExtraCurricularActivity();
                            ...
                            if (!string.IsNullOrEmpty(txtActivity1.Text))
                            {
                                ...
                                {
                                    dbInsertECA2.Insert<DAL.PostgraduateDiplomaExtraCurricularActivity>(newExtraCurricularAct2);
                                }
                            }
                        }
                    }
