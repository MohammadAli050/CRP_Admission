...
{
    public partial class PostgraduateDiplomaPurchaseForm : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                using (var db = new OfficeDataManager())
                {
                    ...
                    DAL.PostgraduateDiplomaAdmissionSetup admissionSetup = db.AdmissionDB.PostgraduateDiplomaAdmissionSetups.Find(admissionSetupId);
        ...
        private void LoadDDL()
        {
            ...
            DAL.PostgraduateDiplomaAdmissionSetup admissionSetup = null;
            DAL.PostgraduateDiplomaAdmissionUnit admissionUnit = null;
            ...
            try
            {
                using (var db = new OfficeDataManager())
                {
                    admissionSetup = db.AdmissionDB.PostgraduateDiplomaAdmissionSetups.Find(admissionSetupIDLong);
                    admissionUnit = db.AdmissionDB.PostgraduateDiplomaAdmissionUnits.Find(admissionUnitIDLong);
                }
            }
            catch (Exception ex)
            {
        ...
        {
            updatePanel_EligibleMessageUP.Visible = true;
            lblEligibleMsgUP.Text = msg;
            lblEligibleMsgUP.CssClass = css;
            updatePanel_EligibleMessage.Visible = true;
        ...
        private void PurchaseApplicationForm()
        {
            ...
            DAL.PostgraduateDiplomaBasicInfo candExist = null;
            ...
            {
                candExist = db.AdmissionDB.PostgraduateDiplomaBasicInfoes
                    .Where(c =>
                        c.DateOfBirth == dob &&
            ...
            try
            {
                ...
                //---------------------------------------------------------------------------------
                DAL.PostgraduateDiplomaCandidateUser candidateUser = new DAL.PostgraduateDiplomaCandidateUser();
                ...
                using (var db = new CandidateDataManager())
                {
                    db.Insert<DAL.PostgraduateDiplomaCandidateUser>(candidateUser);
                ...
                //---------------------------------------------------------------------------------
                DAL.PostgraduateDiplomaBasicInfo candidate = new DAL.PostgraduateDiplomaBasicInfo();
                ...
                candidate.Mobile = smsMobile.Trim().ToString();
                candidate.SMSPhone = smsMobile.Trim().ToString();
                ...
                using (var db = new CandidateDataManager())
                {
                    db.Insert<DAL.PostgraduateDiplomaBasicInfo>(candidate);
                ...
                if (admissionSetup != null)
                {
                    using (var db = new CandidateDataManager())
                    {
                        ...
                        db.AdmissionDB.SPPostgraduateDiplomaCandidatePaymentInsert(id_param, candidateIdLong, null, admissionSetup.AcaCalID, Convert.ToInt32(admissionUnit.UnitCode1), false, admissionSetup.Fee, -99, DateTime.Now);
                ...
                if (admissionSetup != null)
                {
                    ...
                    {
                        ObjectParameter id_param = new ObjectParameter("iD", typeof(long));
                        db.AdmissionDB.SPPostgraduateDiplomaCandidateFormSlInsert(id_param, candidateIdLong, admissionSetup.ID, admissionSetup.AcaCalID, Convert.ToInt32(admissionUnit.UnitCode1), null, candidatePaymentIDLong, DateTime.Now, -99);
                ...
                if (candidateIdLong > 0 && candidatePaymentIDLong > 0 && candidateFormSerialIDLong > 0)
                {
                    ...
                    Response.Redirect("~/Admission/PostgraduateDiploma/PostgraduateDiplomaPurchaseNotification.aspx?value=" + urlParam, false);
                }
                else
                {
                    Response.Redirect("~/Admission/Message.aspx?message=Something went wrong. Please contact the administrator. Error Code PF01X001IE?type=danger", false);
                ...
                using (var db = new CandidateDataManager())
                {
                    ...
                    try
                    {
                        ...
                        if (isSentEmail == true)
                        {
                            ...
                            eLog.Page = "PostGraduateDiplomaPurchaseForm.aspx";
                            eLog.SentBy = "System";
        ...
        private void SendSms(string smsPhone, long candidateId, string value, DAL.CandidatePayment candidatePaymentObj)
        {
            if (!string.IsNullOrEmpty(smsPhone) && smsPhone.Count() == 14 && smsPhone.Contains("+"))
            {
                ...
                if (statusT != "200") //if sms sending fails
                {
                    ...
                    smsLog.Attribute1 = "Sms sending failed in PostGraduateDiplomaPurchaseForm.aspx";
                ...
                else //if sms sending passed
                {
                    DAL_Log.SmsLog smsLog = new DAL_Log.SmsLog();
                    smsLog.AcaCalId = null;
                    smsLog.Attribute1 = "Sms sending successful PostGraduateDiplomaPurchaseForm.aspx";
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            string mobileNumber = txtCountryCodeSMSMobile.Text + txtSmsMobile.Text;
            string emailId = txtEmail.Text.Trim();

            DAL.PostgraduateDiplomaBasicInfo bi = null;
            using (var db = new CandidateDataManager())
            {
                bi = db.AdmissionDB.PostgraduateDiplomaBasicInfoes.Where(x => x.SMSPhone == mobileNumber && x.Email == emailId).FirstOrDefault();
            }

            if (bi != null)
            {
                EligibleMessage("You Email and SMS Number is already Registered in out system..!! Please try again..!!", "text-danger");
                return;
            }
            ...
            using (var db = new OfficeDataManager())
            {
                DAL.PostgraduateDiplomaAdmissionSetup admissionSetup = db.AdmissionDB.PostgraduateDiplomaAdmissionSetups.Find(admissionSetupIDLong);

                if (admissionSetup.ID > 0 && admissionSetup.IsActive == true)
                {
                    DAL.PostgraduateDiplomaAdmissionUnit admissionUnit = db.AdmissionDB.PostgraduateDiplomaAdmissionUnits.Find(admissionSetup.AdmissionUnitID);
