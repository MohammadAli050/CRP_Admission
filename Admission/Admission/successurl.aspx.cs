...
namespace Admission.Admission
{
    public partial class successurl : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                (!String.IsNullOrEmpty(Request.Form["status"])))
                {
                    ...
                    try
                    {
                        ...
                        dLog.NewData = "SUC_01: All Retrun Parameters: " + builder.ToString();
                    ...
                    #region Check_Is_IPN_Update_DB
                    try
                    {
                        string paymentIdString = Request.Form["tran_id"].ToString();
                        ...
                        {
                            lblName.Text = Request.Form["value_b"].ToString(); // Candidate FirstName
                            lblPaymentId.Text = Request.Form["tran_id"].ToString(); // payment id system is sending


                            #region Log Insert Success_02
                            try
                            {
                                DAL_Log.DataLog dLog = new DAL_Log.DataLog();
                                dLog.DateTime = DateTime.Now;
                                ...
                                dLog.PageName = "successurl.aspx";
                                //dLog.OldData = logOldObject;
                                dLog.NewData = "SUC_02: Payment is Updated; PaymentId: " + cp.PaymentId.ToString() + "; CandidateId: " + cp.CandidateID + "; Amount: " + cp.Amount.ToString() + "; IsPaid: Yes";
                                //dLog.SessionInformation = SessionSGD.GetObjFromSession<long>(SessionName.Common_UserId).ToString() + "; " +
                                //    SessionSGD.GetObjFromSession<string>(SessionName.Common_RoleName) + "; C-ID:" + cId;
                            ...
                            using (var db = new CandidateDataManager())
                            {
                                if (cp != null)
                                {
                                    cbi = db.GetCandidateBasicInfoByID_AD(Convert.ToInt64(cp.CandidateID));
                                    if (cbi != null)
                                        cu = db.GetCandidateUserByID_ND(cbi.CandidateUserID);
                    ...
                    /////////////////////////////////////////////////////////////////////////////////
                    DAL.TemporaryTable_1 tmp1 = new DAL.TemporaryTable_1();                        //
                    ...
                    string trans_id = Request.Form["tran_id"].ToString(); // payment id system is sending from purchaseNotification.aspx
                    ...
                    /////////////////////////////////////////////////////////////////////////////////
                    DAL.TemporaryTable_1 tmp2 = new DAL.TemporaryTable_1();                        //
                    ...
                    if (string.IsNullOrEmpty(trans_id))
                    {
                        ...
                        /////////////////////////////////////////////////////////////////////////////////
                        DAL.TemporaryTable_1 tmp3 = new DAL.TemporaryTable_1();                        //
                    ...
                    else
                    {
                        ...
                        /////////////////////////////////////////////////////////////////////////////////
                        DAL.TemporaryTable_1 tmp4 = new DAL.TemporaryTable_1();                        //
                        ...
                        if (cPaymentObj != null)
                        {
                            ...
                            /////////////////////////////////////////////////////////////////////////////////
                            DAL.TemporaryTable_1 tmp5 = new DAL.TemporaryTable_1();                        //
                        ...
                        else
                        {
                            ...
                            /////////////////////////////////////////////////////////////////////////////////
                            DAL.TemporaryTable_1 tmp6 = new DAL.TemporaryTable_1();                        //
                    ...
                    if (string.IsNullOrEmpty(value_d))
                    {
                        ...
                        /////////////////////////////////////////////////////////////////////////////////
                        DAL.TemporaryTable_1 tmp7 = new DAL.TemporaryTable_1();                        //
                    ...
                    else
                    {
                        ...
                        /////////////////////////////////////////////////////////////////////////////////
                        DAL.TemporaryTable_1 tmp8 = new DAL.TemporaryTable_1();                        //
                        ...
                        if (storeId > 0)
                        {
                            ...
                            /////////////////////////////////////////////////////////////////////////////////
                            DAL.TemporaryTable_1 tmp9 = new DAL.TemporaryTable_1();                        //
                            ...
                            /////////////////////////////////////////////////////////////////////////////////
                            DAL.TemporaryTable_1 tmp10 = new DAL.TemporaryTable_1();                       //
                    ...
                    if (storeObj != null)
                    {
                        ...
                        //////////////////////////////////////////////////////////////////////////////////////////////
                        DAL.TemporaryTable_1 tmp11 = new DAL.TemporaryTable_1();                                    //
                    ...
                    if (string.IsNullOrEmpty(plainText_storeId) && string.IsNullOrEmpty(plainText_password))
                    {
                        ...
                        ////////////////////////////////////////////////////////////////////////////////////////
                        DAL.TemporaryTable_1 tmp12 = new DAL.TemporaryTable_1();                              //
                    ...
                    else
                    {
                        ...
                        ///////////////////////////////////////////////////////////////////////////////
                        DAL.TemporaryTable_1 tmp13 = new DAL.TemporaryTable_1();                     //
                    ...
                    if (!string.IsNullOrEmpty(url))
                    {
                        ...
                        ///////////////////////////////////////////////////////////////////////////////
                        DAL.TemporaryTable_1 tmp14 = new DAL.TemporaryTable_1();                     //
                        tmp14.Note = "tmp14 jsonData____" + jsonData;                                //
                        tmp14.DateTimeNow = DateTime.Now;                                            //
                        using (var db = new GeneralDataManager())                                    //
                        {                                                                            //
                            db.Insert<DAL.TemporaryTable_1>(tmp14);                                  //
                        }                                                                            //
                        ///////////////////////////////////////////////////////////////////////////////
                        ...
                        ///////////////////////////////////////////////////////////////////////////////
                        DAL.TemporaryTable_1 tmp15 = new DAL.TemporaryTable_1();                     //
                        tmp15.Note = "tmp15 outputArray____" + outputArray;                          //
                        tmp15.DateTimeNow = DateTime.Now;                                            //
                        using (var db = new GeneralDataManager())                                    //
                        {                                                                            //
                            db.Insert<DAL.TemporaryTable_1>(tmp15);                                  //
                        }                                                                            //
                        ///////////////////////////////////////////////////////////////////////////////
                        ...
                        if ((paymentStatusUpper.Equals("VALID") || paymentStatusUpper.Equals("VALIDATED")) && paymentTran_id.Equals(trans_id))
                        {
                            ...
                            /////////////////////////////////////////////////////////////////////////////
                            DAL.TemporaryTable_1 tmp16 = new DAL.TemporaryTable_1();                   //
                            ...
                            using (var db = new GeneralDataManager())                                  //
                            {                                                                          //
                                db.Insert<DAL.TemporaryTable_1>(tmp16);                                //
                            }                                                                          //
                            /////////////////////////////////////////////////////////////////////////////
                        ...
                        #region View UserName And Password
                    ...
                    else
                    {
                        /////////////////////////////////////////////////////////////////////////////
                        DAL.TemporaryTable_1 tmp16 = new DAL.TemporaryTable_1();                   //
                        tmp16.Note = "tmp22 !string.IsNullOrEmpty(url)____ SSL Transaction Validation Failed;";
                        tmp16.DateTimeNow = DateTime.Now;                                          //
                        using (var db = new GeneralDataManager())                                  //
                        {                                                                          //
                            db.Insert<DAL.TemporaryTable_1>(tmp16);                                //
            ...
            {
                /////////////////////////////////////////////////////////////////////////////
                DAL.TemporaryTable_1 tmp99Catch = new DAL.TemporaryTable_1();                   //
                tmp99Catch.Note = "tmp23 !string.IsNullOrEmpty(url)____Error occured while saving success information   " + ex.Message.ToString();
                tmp99Catch.DateTimeNow = DateTime.Now;                                          //
                using (var db = new GeneralDataManager())                                  //
                {                                                                          //
                    db.Insert<DAL.TemporaryTable_1>(tmp99Catch);                                //
                }                                                                          //
                /////////////////////////////////////////////////////////////////////////////
        ...
        private void SavePayment(dynamic outputArray)
        {
            try
            {
                ...
                if (cPayment != null && cPayment.IsPaid == false)
                {
                    ...
                    try
                    {
                        ...
                        if (AllStepInOneTime == 1)
                        {
                            if (cPayment != null)
                            {
                                ...
                                using (var db1 = new CandidateDataManager())
                                {
                                    ...
                                    additionalInfoObj = db1.GetAdditionalInfoByCandidateID_ND(cId);
                                    ...
                                    if (additionalInfoObj != null)
                                    {
                                        ...
                                        db1.Update<DAL.AdditionalInfo>(additionalInfoObj);
                        ...
                        /////////////////////////////////////////////////////////////////////////////////
                        DAL.TemporaryTable_1 tmp17 = new DAL.TemporaryTable_1();                       //
                        tmp17.Note = "tmp17 Successfully updating CandidatePayment;";
                        tmp17.DateTimeNow = DateTime.Now;                                              //
                        using (var db = new GeneralDataManager())                                      //
                        {                                                                              //
                            db.Insert<DAL.TemporaryTable_1>(tmp17);                                    //
                        }                                                                              //
                        /////////////////////////////////////////////////////////////////////////////////
                    }
                    catch (Exception ex)
                    {
                        ...
                        /////////////////////////////////////////////////////////////////////////////////
                        DAL.TemporaryTable_1 tmp17 = new DAL.TemporaryTable_1();                       //
                        tmp17.Note = "tmp18 Error updating CandidatePayment____" + ex.Message.ToString();
                        tmp17.DateTimeNow = DateTime.Now;                                              //
                        using (var db = new GeneralDataManager())                                      //
                        {                                                                              //
                            db.Insert<DAL.TemporaryTable_1>(tmp17);                                    //
                    ...
                    {
                        ///////////////////////////////////////////////////////////////////////////////
                        DAL.TemporaryTable_1 tmp18 = new DAL.TemporaryTable_1();                     //
                        tmp18.Note = "tmp19 thExist____ is null " + intTransId.ToString();           //
                        tmp18.DateTimeNow = DateTime.Now;                                            //
                        using (var db = new GeneralDataManager())                                    //
                        {                                                                            //
                            db.Insert<DAL.TemporaryTable_1>(tmp18);                                  //
                        }                                                                            //
                        ///////////////////////////////////////////////////////////////////////////////
                        ...
                        catch (Exception ex)
                        {
                            ...
                            /////////////////////////////////////////////////////////////////////////////////
                            DAL.TemporaryTable_1 tmp19 = new DAL.TemporaryTable_1();                       //
                            tmp19.Note = "tmp20 Error inserting TransactionHistory____" + ex.Message.ToString();
                            tmp19.DateTimeNow = DateTime.Now;                                              //
                            using (var db = new GeneralDataManager())                                      //
                            {                                                                              //
                                db.Insert<DAL.TemporaryTable_1>(tmp19);                                    //
                            }                                                                              //
                            /////////////////////////////////////////////////////////////////////////////////
                ...
                using (var db = new CandidateDataManager())
                {
                    if (cPayment != null)
                    {
                        cbi = db.GetCandidateBasicInfoByID_AD(Convert.ToInt64(cPayment.CandidateID));
                        if (cbi != null)
                            cu = db.GetCandidateUserByID_ND(cbi.CandidateUserID);
            ...
            {
                /////////////////////////////////////////////////////////////////////////////////
                DAL.TemporaryTable_1 tmp20 = new DAL.TemporaryTable_1();                       //
                tmp20.Note = "tmp21 Exception savePayment()____" + ex.Message.ToString();      //
                tmp20.DateTimeNow = DateTime.Now;                                              //
                using (var db = new GeneralDataManager())                                      //
                {                                                                              //
                    db.Insert<DAL.TemporaryTable_1>(tmp20);                                    //
                }                                                                              //
                /////////////////////////////////////////////////////////////////////////////////
            }
        }
            ...
            if (candidateId != null)
            {
                if (candidateId > 0)
                {
                        ...
                        !string.IsNullOrEmpty(candidateSmsPhone) && !string.IsNullOrEmpty(candidateEmail))
                    {
                        ...
                        SendEmail(candidate.FirstName, candidateEmail, candidateUsername, candidatePassword, candidate.ID);
                    }
                }
            }
        }
        ...
        private void SendSms(string smsPhone, string username, string password, long candidateId)
        {
            if (!string.IsNullOrEmpty(smsPhone) && smsPhone.Count() == 14 && smsPhone.Contains("+"))
            {
                ...
                if (statusT != "200") //if sms sending fails
                {
                    ...
                    smsLog.Attribute1 = "Sms sending failed in SuccessURL.aspx";
                    smsLog.Attribute2 = "Failed";
                    smsLog.Attribute3 = "SuccessURL.aspx";
                ...
                else //if sms sending passed
                {
                    DAL_Log.SmsLog smsLog = new DAL_Log.SmsLog();
                    smsLog.AcaCalId = null;
                    smsLog.Attribute1 = "Sms sending successful SuccessURL.aspx";
