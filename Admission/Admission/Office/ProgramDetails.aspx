<%@ Page Title="Program Details" Language="C#" MasterPageFile="~/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="ProgramDetails.aspx.cs" Inherits="Admission.Admission.Office.ProgramDetails" %>
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-body" style="margin-bottom: -25px;">
                    ...
                    <asp:ListView ID="lvProgramDetails" runat="server"
                        OnItemDataBound="lvProgramDetails_ItemDataBound"
                        OnItemCommand="lvProgramDetails_ItemCommand"
                        OnItemDeleting="lvProgramDetails_ItemDeleting"
                        OnItemUpdating="lvProgramDetails_ItemUpdating">
                        <LayoutTemplate>
                            <table id="tblProgramDetails"
                                class="table table-hover table-condensed table-striped"
                                style="width: 100%; text-align: left">
                                <tr runat="server" style="background-color: #1387de; color: white;">
                                    <th runat="server">Admission Unit</th>
                        ...
                        <ItemTemplate>
                            <tr runat="server">
                                <td valign="middle" align="left" class="">
                                    <asp:Label ID="lblAdmissionUnit" runat="server" />.
                                </td>
