...
{
    public partial class CandApplicationAddress : PageBase
    {
        ...
        protected void MessageView(string msg, string status)
        {
            ...
            if (status == "success")
            {
                lblMessageAddress.Text = string.Empty;
                lblMessageAddress.Text = msg.ToString();
                lblMessageAddress.Attributes.CssStyle.Add("font-weight", "bold");
                lblMessageAddress.Attributes.CssStyle.Add("color", "green");
            ...
            else if (status == "fail")
            {
                ...
                lblMessageAddress.Text = msg.ToString();
                lblMessageAddress.Attributes.CssStyle.Add("font-weight", "bold");
                lblMessageAddress.Attributes.CssStyle.Add("color", "crimson");
            ...
            {
                lblMessageAddress.Text = string.Empty;
                messagePanel_Address.Visible = false;
            }
