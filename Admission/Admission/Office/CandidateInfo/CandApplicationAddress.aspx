<%@ Page Title="Admin - Application Address" Language="C#" MasterPageFile="~/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="CandApplicationAddress.aspx.cs" Inherits="Admission.Admission.Office.CandidateInfo.CandApplicationAddress" %>
    ...
    <asp:UpdatePanel ID="updatePanelAddress" runat="server" ChildrenAsTriggers="true">
        <ContentTemplate>
            ...
            <div class="admin-container">
                ...
                <!-- Present/Mailing & Permanent Address -->
                <div class="row">
                    <div class="col-md-6">
                            ...
                            <div class="section-body">
                                <table class="form-table-modern">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtPresentAddress" runat="server" CssClass="form-control-modern"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddlPresentDivision" runat="server" CssClass="form-control-modern"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddlPresentDistrict" runat="server" CssClass="form-control-modern" Enabled="false"></asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Upazila</td>
                                        <td>
                                            <asp:TextBox ID="txtPresentUpazila" runat="server" CssClass="form-control-modern"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Country <span class="spanAsterisk">*</span></td>
                                        <td>
                                            <asp:DropDownList ID="ddlPresentCountry" runat="server" CssClass="form-control-modern"></asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Post Code <span class="spanAsterisk">*</span></td>
                                        <td>
                                            <asp:TextBox ID="txtPresentPostCode" runat="server" CssClass="form-control-modern"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Telephone No.</td>
                                        <td>
                                            <asp:TextBox ID="txtPresentPhone" runat="server" CssClass="form-control-modern"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                                ...
                                <table class="form-table-modern">
                                    <tr class="checkbox-row">
                                        <td colspan="2" style="text-align: left;">
                                            <asp:CheckBox ID="CheckBoxSameAsPresentAddress" runat="server" OnCheckedChanged="CheckBoxSameAsPresentAddress_CheckedChanged" AutoPostBack="true" />
                                            <label style="margin-left: 0.5rem; cursor: pointer; display: inline;">Check if same as Present Address</label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Address <span class="spanAsterisk">*</span></td>
                                        <td>
                                            <asp:TextBox ID="txtPermanentAddress" runat="server" CssClass="form-control-modern"
                                                TextMode="MultiLine" Rows="3"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Division <span class="spanAsterisk">*</span></td>
                                        <td>
                                            <asp:DropDownList ID="ddlPermanentDivision" runat="server" CssClass="form-control-modern"
                                    ...
                                    <tr>
                                        <td>District <span class="spanAsterisk">*</span></td>
                                        <td>
                                            <asp:DropDownList ID="ddlPermanentDistrict" runat="server" CssClass="form-control-modern" Enabled="false"></asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Upazila</td>
                                        <td>
                                            <asp:TextBox ID="txtPermanentUpazila" runat="server" CssClass="form-control-modern"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Country <span class="spanAsterisk">*</span></td>
                                        <td>
                                            <asp:DropDownList ID="ddlPermanentCountry" runat="server" CssClass="form-control-modern"></asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Post Code <span class="spanAsterisk">*</span></td>
                                        <td>
                                            <asp:TextBox ID="txtPermanentPostCode" runat="server" CssClass="form-control-modern"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Telephone No.</td>
                                        <td>
                                            <asp:TextBox ID="txtPermanentPhone" runat="server" CssClass="form-control-modern"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                ...
                <div style="text-align: center; padding: 2rem; background: white; border-radius: var(--radius-lg); box-shadow: var(--shadow-md); margin-top: 2rem;">
                    <asp:Button ID="btnSave_Address" runat="server" Text="Save"
                        CssClass="btn btn-primary-modern" OnClick="btnSave_Address_Click" />
