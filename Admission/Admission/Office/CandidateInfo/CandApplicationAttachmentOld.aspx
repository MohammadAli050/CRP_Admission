<%@ Page Title="" Language="C#" MasterPageFile="~/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="CandApplicationAttachmentOld.aspx.cs" Inherits="Admission.Admission.Office.CandidateInfo.CandApplicationAttachmentOld" %>
            ...
            <div class="panel panel-default">
                <div class="panel-heading panelHeaderHeight">
                    <ol class="breadcrumb">
                        ...
                        <li><asp:HyperLink ID="hrefAppDeclaration" runat="server">Declaration</asp:HyperLink></li>
                    </ol>
                </div>
                <%-- end panel heading --%>
