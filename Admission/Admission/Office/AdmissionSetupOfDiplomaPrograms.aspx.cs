...
{
    public partial class AdmissionSetupOfDiplomaPrograms : PageBase
    {
                            ...
                            if (contentlength < 20480000)  //20480000 = kilobites
                            {
                                try
                                {
                                    ...
                                    DAL.AdmissionSetupOtherProgram newDocumentDetailObj = new DAL.AdmissionSetupOtherProgram();
                                        ...
                                        newDocumentDetailObj.ProgramTypeId = 3;  //porog 3 = Diploma 
        ...
        private void LoadData()
        {
            ...
            try
            {
                ...
                using (var db = new OfficeDataManager())
                {
                    list = db.AdmissionDB.SPGetAllAdmissionSetupOtherPrograms(3, null, null).ToList();
                }
