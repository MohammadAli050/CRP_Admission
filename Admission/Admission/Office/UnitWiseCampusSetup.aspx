<%@ Page Title="Faculty Wise Campus Priority Setup" Language="C#" MasterPageFile="~/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="UnitWiseCampusSetup.aspx.cs" Inherits="Admission.Admission.Office.UnitWiseCampusSetup" %>
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4>Faculty/Program Wise Campus Priority Setup</h4>
                </div>
                        ...
                        <ContentTemplate>
                            ...
                            <table class="table_form table_fullwidth">
                                <tr>
                                    ...
                                    <td style="width: 40%">
                                        <asp:DropDownList ID="ddlAdmUnit" runat="server" Width="90%" AutoPostBack="true" OnSelectedIndexChanged="ddlAdmUnit_SelectedIndexChanged"></asp:DropDownList>
                                    </td>
                                    <td class="style_td" style="width: 10%">Venue</td>
                                    <td style="width: 40%">
                                        <asp:DropDownList ID="ddlDistrictSetup" runat="server" Width="90%"></asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4">
                ...
                <div>
                    ...
                    <div>
                        ...
                        <asp:Panel ID="gridviewPanel" runat="server">
                            <asp:GridView ID="gvProgCampusPrior" runat="server"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Venue Name">
                                        <ItemTemplate>
                                            <asp:Label ID="lblProgramDistrictPriorityId" runat="server" Visible="false" Text='<%#Eval("ProgramDistrictPriorityId") %>' Value='<%#Eval("ProgramDistrictPriorityId") %>'></asp:Label>
                                    ...
                                    <asp:TemplateField HeaderText="Priority">
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="hfCampusPriority" Visible="false" Text='<%#Eval("CampusPriority") %>' Value='<%#Eval("CampusPriority") %>' />
                                            <asp:DropDownList runat="server" ID="ddlCampusPriority" Width="100px"></asp:DropDownList>
                                        </ItemTemplate>
                                    </asp:TemplateField>
