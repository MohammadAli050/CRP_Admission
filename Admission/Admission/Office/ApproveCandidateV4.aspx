<%@ Page Title="" Language="C#" MasterPageFile="~/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="ApproveCandidateV4.aspx.cs" Inherits="Admission.Admission.Office.ApproveCandidateV4" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="updatePanelAll" runat="server">
        <ContentTemplate>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-md-4 col-lg-4">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlEducationCategory" runat="server" Width="100%"></asp:DropDownList>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtSSCGpa" runat="server" Text="" Width="100%"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            <div class="form-group">
                                <label><strong>HSC/A-Level/Alim GPA >=</strong></label>
                                <asp:TextBox ID="txtHSCGpa" runat="server" Text="" Width="100%"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlSSCGrpSub" runat="server" Width="100%"></asp:DropDownList>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            <div class="form-group">
                                <label><strong>HSC/A-Level/Alim Group/Subject</strong></label>
                                <asp:DropDownList ID="ddlHSCGrpSub" runat="server" Width="100%"></asp:DropDownList>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtUndergradGpa" runat="server" Text="" Width="100%"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            <%--<div class="form-group">
                                <label><strong>Graduate GPA >=</strong></label>
                                <asp:TextBox ID="txtGraduateGpa" runat="server" Text="" Width="100%" ></asp:TextBox>
                            </div>--%>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlIsFinalSubmit" runat="server" Width="100%"></asp:DropDownList>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            <div class="form-group">
                                <label><strong>Approved</strong></label>
                                <asp:DropDownList ID="ddlIsApproved" runat="server" Width="100%"></asp:DropDownList>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-2">
                    <strong>Message Body<span class="asteriskColor">*</span></strong>
                </div>
                <div class="col-lg-6">
                    <asp:TextBox ID="txtMassageBody" TextMode="MultiLine" runat="server" Height="75px" Width="500px"></asp:TextBox>
                    <%-- <asp:Label ID="lblCnt" runat="server" Width="100px">0</asp:Label>--%>
                </div>
                <div class="col-lg-4">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                        Display="Dynamic"
                        ControlToValidate="txtMassageBody"
                        ErrorMessage="Required"
                        Font-Size="Small"
                        ForeColor="Crimson"
                        ValidationGroup="rfSendSSMS"></asp:RequiredFieldValidator>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-2"></div>
                <div class="col-lg-4">
                    <asp:Button ID="btnSendMassage" runat="server"
                        Text="Send Message"
                        CssClass="float-left"
                        ValidationGroup="rfSendSSMS"
                        OnClick="btnSendMassage_Click" />
                ...
                <div class="col-lg-2">
                 ...
                 <div class="col-lg-2">
                    <asp:Button ID="btnSMSMailBoth" runat="server"
                        Text="Both"
                        CssClass="float-left"
                        ValidationGroup="rfSendSSMS"
                        OnClick="btnSMSMailBoth_Click" />
                </div>
            </div>
