...
{
    public partial class RPTStatusReportFinalSubmit : PageBase
    {
            ...
            try
            {
                if (Convert.ToInt64(ddlSession.SelectedValue) > 0)
                {
                    ...
                    if (list != null && list.Count > 0)
                    {
                        ...
                        ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Admission/Office/Reports/RPTStatusReportFinalSubmit.rdlc");
