<%@ Page Title="Quota Wise Summary and Verification Report" Language="C#" MasterPageFile="~/SiteAdmin.Master" AutoEventWireup="true"
    CodeBehind="RPTQuotaReportDetails.aspx.cs" Inherits="Admission.Admission.Office.Reports.RPTQuotaReportDetails" %>
        ...
        <ContentTemplate>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <h3>Quota Wise Details Report</h3>
                </div>
            </div>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-sm-2 col-md-2 col-lg-2" runat="server" visible="false">
