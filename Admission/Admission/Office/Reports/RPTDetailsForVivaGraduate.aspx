<%@ Page Title="Report for Viva Graduate" Language="C#" MasterPageFile="~/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="RPTDetailsForVivaGraduate.aspx.cs" Inherits="Admission.Admission.Office.Reports.RPTDetailsForVivaGraduate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="col-md-12">
            <div class="panel-default">
                <div class="panel-heading">
                    <strong>REPORT - Details for Viva (Masters)</strong>
                </div>
                <div class="panel-body">
                    ...
                    <table class="table_form">
                        ...
                        <tr>
                            <td>Total Marks:
                                <asp:TextBox ID="txtTotalMarks" runat="server" TextMode="Number"></asp:TextBox>
                        ...
                        <tr>
                            <td>
                                <asp:DropDownList ID="ddlDownloadMode" runat="server" AutoPostBack="true"
                                    OnSelectedIndexChanged="ddlDownloadMode_SelectedIndexChanged">
                                </asp:DropDownList>
                            </td>
                            <td>Total number:
                                <asp:TextBox ID="txtTotalNumber" runat="server" TextMode="Number"></asp:TextBox>
                            </td>
                            <td></td>
                        </tr>
                        <tr>
    ...
    <div class="row">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana"
            ...
            <LocalReport ReportPath="Admission/Office/Reports/RptDetailsForVivaGraduate.rdlc" EnableExternalImages="true"></LocalReport>
        </rsweb:ReportViewer>
