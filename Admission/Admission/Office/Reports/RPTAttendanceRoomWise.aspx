<%@ Page Title="Report - Attendance Sheet" Language="C#" MasterPageFile="~/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="RPTAttendanceRoomWise.aspx.cs" Inherits="Admission.Admission.Office.Reports.RPTAttendanceRoomWise" %>
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <strong>REPORT - Roomwise Attendance</strong>
                </div>
                        ...
                        <ContentTemplate>
                            ...
                            <table class="table_form table_fullwidth">
                                <tr>
                                    ...
                                    <td class="style_td" style="width: 5%">Room</td>
                                    <td style="width: 20%">
