...
{
    public partial class RPTQuotaReport : PageBase
    {
        ...
        protected void btnLoad_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (acaCalId > 0)
                {
                    ...
                    List<DAL.GetAllQuotaInfoSummaryByFacultyAndQuotaWise_Result> list = null;
                    using (var db = new GeneralDataManager())
                    {
                        list = db.AdmissionDB.GetAllQuotaInfoSummaryByFacultyAndQuotaWise(facultyId,
                                                                 acaCalId,
                                                                 eduCatId,
                                                                 true,
                                                                 quotaId).ToList();
                    ...
                    if (list != null && list.Count > 0)
                    {
                        ...
                        ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Admission/Office/Reports/RPTQuotaReport.rdlc");
