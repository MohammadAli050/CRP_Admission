<%@ Page Title="Attendance Report" Language="C#" MasterPageFile="~/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="RPTAttendanceReport.aspx.cs" Inherits="Admission.Admission.Office.Reports.RPTAttendanceReport" %>
                        ...
                        <div class="col-sm-5 col-md-5 col-lg-5">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlAdmUnit" runat="server" Width="100%" CssClass="form-control"
                                    AutoPostBack="true"
                                    OnSelectedIndexChanged="ddlAdmUnit_SelectedIndexChanged"></asp:DropDownList>
                            </div>
                        </div>
