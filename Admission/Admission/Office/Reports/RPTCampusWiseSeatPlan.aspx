<%@ Page Title="" Language="C#" MasterPageFile="~/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="RPTCampusWiseSeatPlan.aspx.cs" Inherits="Admission.Admission.Office.Reports.RPTCampusWiseSeatPlan" %>
        ...
        <ContentTemplate>
            <div class="row">
                <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana"
                    ...
                    <LocalReport ReportPath="Admission/Office/Reports/RptCampusWiseSeatPlan.rdlc" EnableExternalImages="true">
                    </LocalReport>
                </rsweb:ReportViewer>
            </div>
        </ContentTemplate>
