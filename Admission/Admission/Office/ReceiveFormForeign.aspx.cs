...
{
    public partial class ReceiveFormForeign : PageBase
    {
        ...
        private void LoadListView()
        {
            ...
            try
            {
                ...
                //if (acaCalId > 0)
                //{
                List<DAL.SPGetForeignCandidatePaidUnPaidFormInfo_Result> list = null;
                using (var db = new GeneralDataManager())
                {
                    list = db.AdmissionDB.SPGetForeignCandidatePaidUnPaidFormInfo(true,
                                                                            acaCalId,
                                                                            admUnitId,
                                                                            eduCatId,
                                                                            candidatePaymentId,
        ...
        protected void lvFormRequest_ItemDataBound(object sender, ListViewItemEventArgs e)
        {
            ...
            {
                ListViewDataItem currentItem = (ListViewDataItem)e.Item;
                DAL.SPGetForeignCandidatePaidUnPaidFormInfo_Result obj = (DAL.SPGetForeignCandidatePaidUnPaidFormInfo_Result)((ListViewDataItem)(e.Item)).DataItem;
                ...
                hlForm.NavigateUrl = "~/Admission/Office/CandidateInfo/CandApplicationBasic.aspx?val=" + obj.CandidateID.ToString();
