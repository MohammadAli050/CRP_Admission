<%@ Page Title="How To Apply Setup" Language="C#" MasterPageFile="~/SiteAdmin.Master" AutoEventWireup="true" CodeBehind="HowToApplySetup.aspx.cs" Inherits="Admission.Admission.Office.HowToApplySetup" %>
                ...
                <div class="panel-body">
                    ...
                    <table class="table_form table_fullwidth">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtGEDesc" runat="server" TextMode="MultiLine" Rows="10" Width="85%"></asp:TextBox>
                                <ajaxToolkit:HtmlEditorExtender ID="txtGEDescHEE" runat="server" TargetControlID="txtGEDesc" EnableSanitization="true"></ajaxToolkit:HtmlEditorExtender>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtGEDescBen" runat="server" TextMode="MultiLine" Rows="10" Width="85%"></asp:TextBox>
                                <ajaxToolkit:HtmlEditorExtender ID="txtGEDescBenHEE" runat="server" TargetControlID="txtGEDescBen" EnableSanitization="true"></ajaxToolkit:HtmlEditorExtender>
                                <span style="color: crimson">Note: For security reason, please do not use hyperlink or any link to outside website address.</span>
                            </td>
                        </tr>
                    </table>
